  ...
  return (
    <SlideFromLeft delay={delay} className="group relative">
      <div className="flex items-start gap-6 p-7 rounded-2xl border border-primary/30 bg-card/50 backdrop-blur-sm relative overflow-hidden transition-all duration-500 hover:border-primary hover:shadow-xl hover:shadow-primary/10 hover:-translate-y-1">
        ...
        <HoverScale className="relative shrink-0 w-16 h-16 rounded-xl border-2 border-primary/50 bg-linear-to-br from-primary/10 to-primary/5 flex items-center justify-center group-hover:border-primary group-hover:shadow-lg group-hover:shadow-primary/30 transition-all duration-500">
        ...
        <div className="flex-1 relative z-10">
          <div className="flex items-center gap-3 mb-2">
            ...
            <CheckCircle2 className="w-5 h-5 text-primary opacity-0 group-hover:opacity-100 transition-all duration-300 transform -translate-x-2.5 group-hover:translate-x-0" />
          </div>
          ...
          <div className="mt-4 h-0.5 bg-linear-to-r from-primary/50 via-primary to-transparent transform scale-x-0 group-hover:scale-x-100 transition-transform duration-700 origin-left" />
        </div>
      ...
      {number < 4 && (
        <div className="hidden lg:block absolute left-8 top-full w-0.5 h-12 bg-linear-to-b from-primary/50 to-transparent" />
      )}
    </SlideFromLeft>
  );
}
